...
public:
  ...
  virtual antlrcpp::Any visitMatrixType(AslParser::MatrixTypeContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitMatrixIndex(AslParser::MatrixIndexContext *ctx) override {
    return visitChildren(ctx);
  }
