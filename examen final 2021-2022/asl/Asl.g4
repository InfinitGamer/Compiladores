...
type    : basic           # basicType
        | 'matrix' CLAUOP INTVAL ',' INTVAL CLAUCL 'of' t=basic #matrixType
...
left_expr
        ...
        | left_expr CLAUOP expr ',' expr CLAUCL
        | ident
        ;

// Grammar for expressions with boolean, relational and aritmetic operators
expr    : expr op=EXCL #factorial
        | (op=MINUS | op=PLUS | op=NOT) expr  # unary
        | left_expr CLAUOP expr ',' expr CLAUCL # matrixIndex
